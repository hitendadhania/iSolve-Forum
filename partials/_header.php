...
<a class="navbar-brand" href="/Forums">iSolve</a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
        echo '<form class="form-inline my-2 my-lg-0" method="GET" action ="search.php" >
                ...
                <p class="my-0 mx-2 text-danger">Welcome ' . $_SESSION['useremail'] . '</p>
        ...
        <div class="mx-2">
            ...
            <button class="btn btn-outline-danger" data-toggle="modal" data-target="#signupModal">Signup</button>
        </div>';
    }
...
if(isset($_GET['error']) && $_GET['error'] == "misMatch"){
    echo '<div class="alert alert-danger alert-dismissible fade show my-0" role="alert">
            <strong>Error!</strong> Invalid Credentials or Password did not match.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>';
...
if(isset($_GET['error']) && $_GET['error'] == "exist"){
    echo '<div class="alert alert-danger alert-dismissible fade show my-0" role="alert">
            <strong>Error!</strong> User alreeady exists.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>';
